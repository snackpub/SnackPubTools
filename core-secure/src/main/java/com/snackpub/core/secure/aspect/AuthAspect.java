 ...
 */
package com.snackpub.core.secure.aspect;

import com.snackpub.core.secure.annotation.PreAuth;
import com.snackpub.core.secure.auth.AuthFun;
...
public class AuthAspect implements ApplicationContextAware {
	 ...
	 */
	@Around(
		"@annotation(com.snackpub.core.secure.annotation.PreAuth) || " +
			"@within(com.snackpub.core.secure.annotation.PreAuth)"
	)
