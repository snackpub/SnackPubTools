...
public class LogAbstractUtil {
     ...
     */
    public static void addOtherInfoToLog(LogAbstract logAbstract, RisesinProperties bladeProperties, ServerInfo serverInfo) {
