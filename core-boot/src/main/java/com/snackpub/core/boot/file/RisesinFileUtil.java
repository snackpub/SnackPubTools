...
public class RisesinFileUtil {
     ...
     * @return BladeFile
     */
    public static RisesinFile getFile(MultipartFile file) {
     ...
     * @return RisesinFile
     */
    public static RisesinFile getFile(MultipartFile file, String dir) {
     ...
     * @return RisesinFile
     */
    public static RisesinFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
        return new RisesinFile(file, dir, path, virtualPath);
    }
     ...
     * @return RisesinFile
     */
    public static List<RisesinFile> getFiles(List<MultipartFile> files) {
     ...
     * @return RisesinFile
     */
    public static List<RisesinFile> getFiles(List<MultipartFile> files, String dir) {
     ...
     * @return RisesinFile
     */
    public static List<RisesinFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
        List<RisesinFile> list = new ArrayList<>();
        for (MultipartFile file : files) {
            list.add(new RisesinFile(file, dir, path, virtualPath));
        }
        return list;
    }
}
